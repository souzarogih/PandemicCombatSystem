...
public class LocalizationDTO implements Serializable{
	...
	public LocalizationDTO(Integer localization_id, String lat, String lng, Instant localization_create_date,
	...
	public LocalizationDTO(Localization entity) {
		...
		this.localization_create_date = entity.getLocalization_create_date();
		this.localization_last_update = entity.getLocalization_last_update();
	}
	...
	public String toString() {
		return "LocalizationDTO [localization_id=" + localization_id + ", lat=" + lat + ", lng=" + lng
